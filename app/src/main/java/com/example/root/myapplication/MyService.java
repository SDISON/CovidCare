...
public class MyService extends Service {
    ...
    public void showNotification(String s) {
        ...
        Notification notification = new NotificationCompat.Builder(this, "1").setSmallIcon(R.drawable.ic_add_alert_black_24dp).setContentTitle("ALERT").setContentText(s).setPriority(NotificationCompat.PRIORITY_HIGH).build();
    ...
    public void discoveryBroadcaster() {
        receiver2 = new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                Log.v(MainActivity.TAG, "starting discovery");
                String action = intent.getAction();
